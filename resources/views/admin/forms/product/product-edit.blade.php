                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" action="{{ url('/forms/product/product-add') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="brand_id" value="{{ $productById->id }}">
                                <div class="form-group">
                                    <label for="product_name" class="col-sm-4 control-label">Product Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" id="product_name" value="{{$productById->product_name}}" name="product_name" class="form-control" placeholder="Please Type Product Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="product_description" class="col-sm-4 control-label">Product Description</label>
                                    <div class="col-sm-8">
                                        <textarea name="product_description" id="product_description" class="form-control" placeholder="Please Type Product Description" id="" cols="30" rows="10">{{$productById->product_description}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" value="{{$productById->product_price}}" class="form-control" id="product_price" name="product_price" placeholder="Please Type Product Price">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="product_quantity" class="col-sm-4 control-label">Product Quantity</label>
                                    <div class="col-sm-8">
                                        <input type="number" value="{{$productById->product_quantity}}" class="form-control" id="product_quantity" name="product_quantity" placeholder="Please Type Product Quantity">
                                    </div>
                                </div>
                                <div class="form-group">
