...
@section('body_content')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <form name="editCategoryForm" class="form-horizontal" action="{{ url('/forms/category/category-update') }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="category_name" value="{{ $categoryById->category_name }}" name="category_name" class="form-control" placeholder="Please Type Category Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="category_description" class="col-sm-4 control-label">Category Description</label>
                                    <div class="col-sm-8">
                                        <textarea name="category_description" id="category_description" class="form-control" placeholder="Please Type Category Description" id="" cols="30" rows="10">{{ $categoryById->category_description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="box-footer">
                                    ...
                                    <button type="submit" name="btn_add_category" class="btn btn-primary pull-right">Update Category</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        document.forms['editCategoryForm'].elements['mainmenu_id'].value='{{ $categoryById->mainmenu_id }}';
        document.forms['editCategoryForm'].elements['category_publish_status'].value='{{ $categoryById->category_publish_status }}';
    </script>
@endsection