    ...
    <section class="about2">
        <div class="container">
            <div class="row wow fadeInUp">
                <div class="col-md-5">
                    <img src="{{ asset('front_resturent') }}/img/about.png" class="img-responsive" alt="" />
                </div>
                ...
                <div class="col-md-12">
                    <div class="services-slider wow fadeIn">
                        <div class="service-content text-center">
                            <img src="{{ asset('front_resturent') }}/img/ico1.png" class="center-block" alt="" />
                            <h4 class="text-uppercase">Birthday Party</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
                        </div>
                        <div class="service-content text-center">
                            <img src="{{ asset('front_resturent') }}/img/ico2.png" class="center-block" alt="" />
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center">
                    <div class="team-staff wow fadeInUp" data-wow-delay="0.2s">
                        <img src="{{ asset('front_resturent') }}/img/team/1.png" class="img-responsive center-block" alt="" />
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <div class="team-staff wow fadeInUp" data-wow-delay="0.4s">
                        <img src="{{ asset('front_resturent') }}/img/team/2.png" class="img-responsive center-block" alt="" />
                        <h4>Enter Name Here</h4>
                        <p>Designation here</p>
                        <ul class="team-social">
                            <li><a href="http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <div class="team-staff wow fadeInUp" data-wow-delay="0.6s">
                        <img src="{{ asset('front_resturent') }}/img/team/3.png" class="img-responsive center-block" alt="" />
                        <h4>Enter Name Here</h4>
                        <p>Designation here</p>
                        <ul class="team-social">
                            <li><a href="http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6 text-center">
                    <div class="team-staff wow fadeInUp" data-wow-delay="0.8s">
                        <img src="{{ asset('front_resturent') }}/img/team/4.png" class="img-responsive center-block" alt="" />
                        <h4>Enter Name Here</h4>
                        <p>Designation here</p>
                        <ul class="team-social">
                            <li><a href="http://www.facebook.com"><i class="fa fa-facebook"></i></a></li>
        ...
        <div class="container">
            ...
            <div class="food-menu wow fadeInUp">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="menu-btn">
                            <a class="btn btn-default btn-lg" href="{{ url('/menu') }}" role="button">Explore our menu</a>
                        </div>
                    </div>
                </div>
            </div>
